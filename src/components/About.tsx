    ...
    return (
        <div>
            ...
            <div className='flex flex-col mx-6 items-start'>
                ...
                <p className='text-[#999999] text-[16px]'>Our story is one of continuous growth and evolution. We started as a small team with big dreams, determined to create a real estate platform that transcended the ordinary. Over the years, we've expanded our reach, forged valuable partnerships, and gained the trust of countless clients.</p>
            </div>
            <section className="flex mx-6 flex-wrap gap-[1.2rem] mt-[4rem]">
